export default function PonukyPage() {
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <a href="/ponuky/nova" className="px-4 py-2 bg-[#66bb6a] text-white text-sm font-medium rounded-[8px] hover:bg-[#57a85b] transition-colors">
          + Nová ponuka
        </a>
      </div>
      <div className="bg-white rounded-[10px] shadow-[0_1px_3px_rgba(0,0,0,0.08)] p-8 text-center text-[#8b9bb4]">
        ...
        <p className="text-sm mt-1">Šablóny, PDF export, emailové odosielanie</p>
      </div>
    </div>
  )
}
