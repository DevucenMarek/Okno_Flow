export default function ProtokolyPage() {
  return (
    <div className="space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-[#1a2332]">Preberací protokol</h1>
        <p className="text-sm text-[#8b9bb4]">Podpis zákazníka, fotky, PDF – povinný krok pred faktúrou</p>
      </div>
